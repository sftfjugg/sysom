export default {
  ...
  'pages.login.passwordLogin.errorMessage': '错误的用户名和密码(admin/123456)',
  'pages.login.failure': '登录失败，请重试！',
  'pages.password.failure': '密码修改失败，请重试！',
  ...
  'pages.login.row_password.placeholder': '请输入原始密码！',
  'pages.login.new_password.placeholder': '请输入新密码！',
  'pages.login.new_password_again.placeholder': '请再次输入新密码！',
  'pages.login.password.required': '密码是必填项！',
  'pages.login.row_password.required': '原始密码是必填项！',
  'pages.login.new_password.required': '新密码是必填项！',
  'pages.login.new_password_again.required': '新密码是必填项！',
  ...
  'pages.diagnose.instance': "实例",
  'pages.diagnose.offline_log': "离线日志",
  'pages.diagnose.offline_import.instance_tip': "实例ID，用来区分不同的节点，此处不会校验实例ID的有效性",
  'pages.diagnose.offline_import.instance_placeholder': "例如：127.0.0.1",
  'pages.diagnose.offline_import.offline_log_tip': "诊断命令在节点端的执行结果",
  'pages.diagnose.offline_import.title': "离线日志导入",
  ...
  'pages.hotfix.patch_path': '补丁路径',
  'pages.hotfix.delete_hotfix_not_exist': '要删除的hotfixID不存在',
  'pages.hotfix.failed.formal': '构建失败的热补丁不能转正式包',
  'pages.hotfix.operation': '操作',
  'pages.hotfix.delete': '删除',
  ...
  'pages.hotfix.kernel_devel_location': 'devel链接',
  'pages.hotfix.kernel_debuginfo_location': 'debuginfo链接',
  'pages.hotfix.kernel_repo_branch': 'git标签/分支',
  ...
  'pages.account.edit_modal_title': '编辑用户信息',
  'pages.account.required_password': '用户密码必填!',
  'pages.account.required_username': '用户名必填!',
  'pages.account.is_delete_account': '确定废弃该账号?',
  'pages.account.yes': '确定',
  'pages.account.think': '我再想想',
  'pages.account.input_username': '请输入用户名',
  'pages.account.input_description': '请输入简介',
  'pages.account.input_password': '请输入密码',
  'pages.account.deleting': '删除中',
  'pages.account.delete_success': '删除成功',
  'pages.account.create_success': '创建成功',
  'pages.account.create_account_modal': '创建用户',
  'pages.account.add_account': '添加账号',
};