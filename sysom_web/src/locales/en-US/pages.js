export default {
  ...
  'pages.diagnose.instance': "instance",
  'pages.diagnose.offline_log': "Offline log",
  'pages.diagnose.offline_import.instance_tip': "Instance ID, used to distinguish between different nodes, the validity of the instance ID is not verified here.",
  'pages.diagnose.offline_import.instance_placeholder': "Eg.：127.0.0.1",
  'pages.diagnose.offline_import.offline_log_tip': "The result of the execution of the diagnostic command on the node side",
  'pages.diagnose.offline_import.title': "Import offline log",
  'pages.diagnose.offline_import.success': "Import success",
  'pages.diagnose.offline_import.failed': "Import failed",
  'pages.diagnose.offline_import.btn': "Offline import",
